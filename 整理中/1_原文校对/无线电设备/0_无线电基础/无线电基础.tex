...
声音是一种机械波，是物体振动产生的声波在介质（如空气、水等）中传播的结果。在无线电技术中，声音是一种重要的信息载体，通过麦克风等换能器转换为电信号，再经过调制、传输、解调等过程，最终还原为声音。

声音具有以下基本特性：
\begin{itemize}[leftmargin=3.5em]
    \item \textbf{频率}：声音的高低，单位为赫兹（Hz），人耳可听范围约为20Hz-20kHz
    \item \textbf{振幅}：声音的强弱，决定了声音的响度
    \item \textbf{音色}：声音的特色，由谐波成分决定
    \item \textbf{相位}：声音的时间关系，影响声音的空间感
\end{itemize}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{2.5cm}|p{2.5cm}|p{3.5cm}|p{4cm}|}
        ...
        \hline
        超长波 & 10000~100000米 & 30~3千赫 & 无线电导航和通讯 \\
        \hline
        长波 & 3000米以上 & 100千赫以下 & 电报通讯 \\
        \hline
        中波 & 3000~200米 & 100~1500千赫 & 广播 \\
        \hline
        中短波 & 200~50米 & 1500~6000千赫 & 电报通讯、广播 \\
        \hline
        短波 & 50~10米 & 6000~30000千赫 & 电报通讯、广播 \\
        \hline
        超短波 & 10米以下 & 30,000千赫以上 & 雷达、电视、无线电导航和接力通讯等 \\
        \hline
        微波 & 1米以下 & $0.3\times10^6$~$300\times10^6$千赫 & 微波中继通讯、导航、雷达、干燥、加热等 \\
        \hline
    \end{tabular}
    \caption{传统无线电波段划分表}
...
具体来说，收音机一般只用中波和短波：
\begin{itemize}[leftmargin=3.5em]
    \item \textbf{中波}：频率范围规定为535千赫至1605千赫（535kHz-1605kHz）
    \item \textbf{短波}：频率范围规定为2000千赫至24000千赫（2000kHz-24000kHz），但常用3500千赫至18000千赫（3500kHz-18000kHz）
\end{itemize}
