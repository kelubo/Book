...
调谐电路是无线电接收机和发射机中的核心组成部分，用于选择特定频率的信号或产生特定频率的振荡。本章将介绍调谐电路的基础理论、LC调谐电路、晶体调谐电路以及现代调谐系统的基本原理。
...
\begin{itemize}
    \item \textbf{谐振频率}：电路发生谐振时的频率，不同类型的谐振电路有不同的计算公式
    \item \textbf{品质因数Q}：反映电路的选择性，Q值越高选择性越好，不同类型的谐振电路有不同的Q值计算公式
...
LC调谐电路的谐振频率由电感L和电容C决定：

\begin{equation}
f_0 = \frac{1}{2\pi\sqrt{LC}}
\label{eq:lc_resonance_frequency}
\end{equation}
...
不同容量的可变电容器需要配合不同电感量的线圈，以实现所需的频率覆盖范围。谐振频率由公式\eqref{eq:lc_resonance_frequency}决定。

\begin{center}
\small
\begin{tabular}{|p{2.5cm}|p{1.5cm}|p{2cm}|p{2cm}|p{1.5cm}|p{1.5cm}|}
\hline
...
\begin{itemize}
  ...
  \item 若需要覆盖更低的频率（如150 kHz），可：
    \begin{itemize}
      \item 增加线圈电感量至约3 mH，配合365 pF可变电容器：$ f_{min} = \frac{1}{2\pi\sqrt{3\times10^{-3} \times 365\times10^{-12}}} \approx 153 \text{ kHz} $
      \item 或使用更大容量的可变电容器（如1000 pF），配合1 mH线圈：$ f_{min} = \frac{1}{2\pi\sqrt{1\times10^{-3} \times 1000\times10^{-12}}} \approx 159 \text{ kHz} $
    \end{itemize}
\end{itemize}
